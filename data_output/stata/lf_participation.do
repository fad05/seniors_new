...
*drop _merge
line lfp age
twoway (line lfp age)(line mean_lfp age), ylabel(0(0.2)1,grid) name(lfp)  yscale(range(0 1))  ytitle(Labor force participation) xtitle(Age) legend(label(1 "Model") label(2 "Data"))
quietly graph export "model_fit/lfp_model_data.png", width(3000) height(2500) replace
...
*collapse lfp lfp_data, by(agecat)

*twoway (line lfp agecat)(line lfp_data agecat), name(acecat_lfp)
